...
<body>
    ...
    <form action="/cambiocontrasena" method="post" >
        ...
        <div class="container">
            <center>
               <span>
                <b><h3 style="color: #009FE3 ">Cambio de contraseña</h3></b>
            </span> 
            </center>       
        <br>
            @csrf
            ...
            <div class=" form-floating mb-3">
                <input type="Password" name="password"  class="form-control" placeholder="Contraseña Actual" value="{{old('password')}}">
                <label for="password" >Contraseña Actual:</label>
            </div>
            <br>
            <div class="form-floating mb-3">
                
                <input type="Password" name="nuevapassword"  class="form-control" placeholder="Nueva Contraseña" value="{{old('nuevapassword')}}">
                <label for="nuevapassword" > Nueva Contraseña:</label>
            </div>
            <br>
            <div class="form-floating mb-3">
                
                <input type="Password" name="confirmacion-password"  class="form-control" placeholder="Confrimar Contraseña" value="{{old('confirmacion-password')}}">
                <label for="conpassword" > Confirmar Contraseña:</label>
            </div>
            <br>
            <input type="submit" name="Actualizar_contraseña" value="Cambiar" class="button-edit"> 
    </form>
</div>
</body>
</html>